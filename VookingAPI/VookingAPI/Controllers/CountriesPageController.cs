...
{
    public class CountriesPageController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "CountryId,CountrySortName,CountryName,CountryPhoneCode")] Countries countries)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "CountryId,CountrySortName,CountryName,CountryPhoneCode")] Countries countries)
        {
            if (ModelState.IsValid)
            {
